...
# 左侧工具栏
with st.sidebar:
    st.subheader('凤凰FM交互式资讯助手')
    chat_name = st.selectbox("会话名称:", ["默认", "会话1"], key="chat_name", on_change=on_chat_change)
...
if query := st.chat_input('输入您要听的资讯'):
    ...
    if streaming:
        ...
        os.environ["APPBUILDER_TOKEN"] = 'bce-v3/ALTAK-JDdbJTm8UQvC6FcVmvYf3/ad840bbae22aa62ebd916d5f81d75d580d5ed00e'
